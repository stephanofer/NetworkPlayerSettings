...
class CountryAssetCatalogTest {
    ...
    void rejectsAliasCollisionsAndMissingFallback() {
        ...
        final CountryAsset futureAliasCollisionWithCode = new CountryAsset("BR", "Brazil", VALID_BASE64, Set.of("am"));
        ...
        final IllegalArgumentException futureAliasCodeCollision = assertThrows(
            IllegalArgumentException.class,
            () -> new CountryAssetCatalog(List.of(unknown, futureAliasCollisionWithCode, armenia))
        );
        assertTrue(futureAliasCodeCollision.getMessage().contains("am"));
