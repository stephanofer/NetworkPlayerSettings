...
2. Agregar la dependencia de compilación desde Maven Local: `com.stephanofer:networkplayersettings:2.1.1`.
...
- El repositorio publica para desarrollo local con `maven-publish`: `com.stephanofer:networkplayersettings:2.1.1` mediante `publishToMavenLocal`.
